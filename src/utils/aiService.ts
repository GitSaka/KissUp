// 🤖 Service d'Intelligence Artificielle pour les bots de KissUP (Basé sur le modèle stable qui fonctionne)
...
export const generateBotResponse = async (
  ...
  try {
    ...
    // ⚡ On utilise exactement le même modèle stable que dans ton autre app
